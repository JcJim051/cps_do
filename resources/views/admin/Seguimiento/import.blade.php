...
@section('header')
    <section class="container-fluid">
        <h2>
            <span class="text-capitalize">Importar Contratos</span>
        </h2>
    </section>
@endsection
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="alert alert-info" role="alert">
                ...
                <a href="{{ url($crud->route . '/template') }}" class="btn btn-xs btn-primary float-end">
            ...
            {{-- LISTADO DE ERRORES DE IMPORTACIÓN (Añadido) --}}
                            ...
                            <table class="table mb-0 table-striped table-condensed">
                                ...
                                <tbody>
                                    @foreach ($importFailures as $failure)
                                        {{-- Usamos un operador ternario para alternar el fondo de las filas --}}
